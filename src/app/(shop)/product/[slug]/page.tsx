          ...
          >
            <div className="bg-white lg:rounded-2xl lg:border lg:border-gray-100 lg:shadow-sm overflow-hidden lg:sticky lg:top-24">
              ...
              >
                ...
                <button
                  className="absolute top-4 right-4 w-10 h-10 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-colors z-10"
                  onClick={(e) => {
                    e.stopPropagation();
                    toggleWishlist(product.id);
                  }}
                >
                  <Heart className={cn("w-5 h-5", wishlisted ? "fill-red-500 text-red-500" : "text-gray-500 hover:text-red-500")} />
                </button>
          ...
          >
            ...
            <div className="flex items-center gap-2 bg-green-50 rounded-xl p-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">2-3 business days • Free delivery on orders over Rs. 1,000</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-400">
                  Total: {formatPrice((product.discount_price || product.price) * quantity)}
                </span>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={cn(
                    "flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-white transition-all",
                    addedToCart
                      ? "bg-green-500"
                ...
                <button
                  ...
                  disabled={(product.stock || 0) === 0}
                  className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3.5 rounded-xl transition-colors shadow-lg shadow-orange-600/25 disabled:opacity-50"
                >
                  Buy Now
                </button>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2 bg-gray-50 rounded-xl p-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Orders over Rs. 1,000</p>
                </div>
              </div>
              <div className="flex items-center gap-2 bg-gray-50 rounded-xl p-3">
